    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "                            <tr>\n"
                    + "                                <td>\n"
                    + "                                    <p>Huidig ziekenhuis:</p>\n"
                    + "                                </td>\n"
                    + "                                <td>\n"
                    + "                                    <input id=\"veld\" name=\"ww\" value=\"" + patient.getHuidigZiekenuis() + "\" type=\"text\" readonly>\n"
                    + "                                </td>\n"
                    + "                            </tr>\n"
                    + "                            <tr>\n"
                    + "                                <td>\n"
                    + "                                    <p>Huidige behandelaar:</p>\n"
                    + "                                </td>\n"
                    + "                                <td>\n"
                    + "                                    <input id=\"veld\" name=\"ww\" value=\"" + patient.getHuidigeBehandelaar() + "\" type=\"text\" readonly>\n"
                    + "                                </td>\n"
                    + "                            </tr>\n"
                    + "                            <tr>\n"
                    + "                                <td>\n"
                    ...
                    + "                                </td>\n"
                    + "                                <td>\n"
                    + "                                    <input id=\"veld\" name=\"ww\" value=\"" + patient.getVerdenking() + "\" type=\"text\" readonly>\n"
                    + "                                </td>\n"
                    + "                            </tr>\n"
                    + "                        </table>	\n "
                    + "                         <div id=\"rechts\">\n"
